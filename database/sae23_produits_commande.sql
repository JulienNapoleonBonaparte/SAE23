...
CREATE TABLE `produits_commande` (
  ...
  CONSTRAINT `produits_commande_ibfk_1` FOREIGN KEY (`commande_id`) REFERENCES `commandes` (`numero_commande`),
  CONSTRAINT `produits_commande_ibfk_2` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`id`)
...
-- Dump completed on 2023-05-31 14:35:46
